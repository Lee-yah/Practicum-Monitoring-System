...
$iuserId =$iusername=$ipassword =$irole = $iresetPassword =" ";
...
<div class="ml-5"><a href="\www\fproj\startbootstrap\User.php" ><button  type="button" class="btn btn-outline-light btn-circle btn-lg"><i class="fa fa-close"></i></button>  
</a> </div>
