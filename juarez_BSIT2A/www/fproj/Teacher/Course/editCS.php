...
$CMid = $_GET['GCourse'];
    $query = " select * FROM Course where course_id='".$CMid."'";
...
<div class ="form cols-6 colss-11">
  <form  id="myForm shadow" action="updateCS.php?GCourseID=<?php echo $CMid ?>" method="post"  class="needs-validation" novalidate>
         <h1 class="addtext mt-4">Edit Couse Form</h1>
          <br><br>
           <div class="alert alert-info" id="success-alert">
           <button type="button" class="close" data-dismiss="alert">x</button>
           <strong>Processing! </strong> <?php echo $Cmc ?>  is being updated 
           </div>
             ...
             <div class=" input-group mb-3">
                <div class="input-group-prepend">
                          <span class="input-group-text">Course</span>
                           <input type="text" name="cmid"  class="form-control" value ="<?php echo $Cmid ?>" disabled>
                </div>
  
                          
                               <input name="course" list="course" class="form-control instructorh"  value="<?php echo  $Cmc?>" required>
                  ...
                  <label>Major:</label>  
                        <input type="text" name="major" class="form-control" value="<?php echo  $Cmm?>"required> 
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please enter a valid input in this field.</div>
                        <br>
                  </div>
              
                   <input type="submit" name="UpCourse" class="btn btn-primary" value="Update Course">
