...
$userid=$_SESSION['user_id'];
    ...
    $query = " select * FROM ins_csdetails where user_id='".$userid."'";
     ...
     <div class="col-10 ">
          <div class="card shadow mb-4 " >
              <div class="card-header py-3">
                       <h4 class="m-0 font-weight-bold maroon">Practicum Records</h4>
                 </div>
                  <div class="card-body ">
                                   ...
                                   <tbody id="myTablee">
                                        <?php 
                                            ...
                                            ?>
                                                               ...
                                                               <td> <a href="\www\fproj\Student\Student\uploads\<?php echo $row['filename']; ?>" target="_blank">
                                                                  <button  type="button" class="btn btn-outline-info" style="font-size:10px; "> View
                                                                </button></a> </td>

                                                                 <td><?php echo $status ?></td>
                  <td><a href="Student/editstats.php?uncheckID=<?php echo $rid ?>">
                 <button  type="button" class="btn btn-outline-secondary" style="font-size:10px;"> Uncheck
                   <!-- <i class="material-icons"> </i> --></button></a></td>
                  <td><a href="Student/editstats.php?checkID=<?php echo $rid ?>">
                 <button  type="button" class="btn btn-outline-danger" style="font-size:10px;"> Checked
