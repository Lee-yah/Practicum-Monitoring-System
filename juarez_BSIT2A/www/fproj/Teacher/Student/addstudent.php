...
<div class ="form cols-10 colss-11 mt-4">
  <form  id="myForm shadow" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"  class="needs-validation" novalidate>
                  ...
                  <label>Semester:</label> 
                    <div class="form-group ">
                          <select name="ssemester" class="custom-select instructorh"  >
                             ...
                             <option value="2nd Semeste">2nd Semester</option>
        ...
        <div class="row mt-5">
          <!--   date("Y-m-d") -->
                      ...
                      <label>Start Date:</label> 
                          <input type="text" name="sstartdate" class="form-control" placeholder="YYYY-MM-DD" maxlength="10" pattern="^[0-9]{4}-[0-9]{2}-[0-9]{2}$" >
                           <div class="valid-feedback">Valid.</div>
                           <div class="invalid-feedback">Please enter a valid input in this field.</div>
                     ...
                     <label>End Date:</label> 
                          <input type="text" name="senddate" class="form-control" placeholder="YYYY-MM-DD" maxlength="10" pattern="^[0-9]{4}-[0-9]{2}-[0-9]{2}$" >
                          <div class="valid-feedback">Valid.</div>
                          <div class="invalid-feedback">Please enter a valid input in this field.</div>
      ...
      <div class="row mt-2">
                  ...
                  <div class="col form-group form-group-sm">
                  <label>User Id:</label>  
                        <input type="text" name="suserId" class="form-control"   pattern="^[0-9]*$" value="<?php echo $suserId; ?>"> 
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please enter a valid input in this field.</div>
                        <br>
                  </div>
