...
<div class ="card-body  ">
             ...
             <form  id="myForm shadow" action="updatepass.php?Guser=<?php echo$Gsid ?>" method="post"  class="needs-validation" novalidate>
                 <h3 style="color: maroon;font-size: 18pt;font-weight: bold;">Change Password</h3>
                       <div class="form-group form-group-sm">
                     <label>New Password:</label> 
                        <input type="text" name="newpass" class="form-control"  minlength="8" autocomplete="off" required>
