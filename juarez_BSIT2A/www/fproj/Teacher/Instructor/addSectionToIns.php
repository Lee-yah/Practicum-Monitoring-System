...
<?php
//variables 
 $Rid =  $section = $instructor =$SY =" ";


if ($_SERVER["REQUEST_METHOD"] == "POST") {
  # code...

if (isset($_POST['addStoI'])) {
...
<div class ="form cols-6 colss-11 ">
  <form  id="myForm shadow" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"  class="needs-validation" novalidate>
         <h1 class="addtext mt-4">Add Section under Instructor Form</h1>
          <br><br>
...
<div class="form-group form-group-sm  mt-4">
    <div class="form-group form-group-sm ">
                  <label>Record Id:</label>  
                       <input type="text" name="Rid" class="form-control" placeholder="Last number: <?php echo $ISid ?>" autocomplete="off" value="<?php echo $s=$ISid+1;?>"> 
...
<div class="form-group form-group-sm  ">
    <div class="form-group form-group-sm mb-4">
                  <label>School Year:</label>  
                        <input type="text" name="SY" class="form-control" pattern="^[0-9]{4}-[0-9]{4}$" placeholder="format (2020-2021)"required> 
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please enter a valid input in this field.</div>
                        <br>
  </div>        
...
<div class="cols-12 mt-5">
                   <input type="submit" name="addStoI" class="btn btn-primary" value="Add Section">
...
$sql = "INSERT INTO inssection (inssection_id,i_id,section_id,SY) 
          VALUES('$Rid','$instructor','$section','$SY' )";
