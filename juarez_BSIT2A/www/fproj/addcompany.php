...
<div class ="form">
      ...
      <form  id="myForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"  class="needs-validation" novalidate>
         <h2 class="addtext">Add Company Form</h2>
          <br><br>
         ...
         <label>Company Name:</label>  
          ...
          <label >   Company Description:  </label> 
                    <textarea name="description" rows="5" cols="40"class="form-control"  required></textarea>       
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">Please fill out this field.</div>
                     <br><br>
...
$sql = "INSERT INTO company (c_name,c_address,c_email,c_contactno,c_description) 
