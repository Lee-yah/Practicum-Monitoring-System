      ...
      <div class=" input-group mb-3">
             <div class="input-group-prepend">
                          <span class="input-group-text">New Section</span>
                           <input type="text" name="Sid"  class="form-control" placeholder="Optional Last Number: <?php echo $sectionid ?>" value=" <?php echo $s=$sectionid+1; ?>">
              </div> 
...
$sql = "INSERT INTO section (section_id,section,course_id) 
          VALUES('$Sid','$section','$course' )";
