...
<div class ="form cols-6 colss-11 ">
  <form  id="myForm shadow" action="updateSec.php?GID=<?php echo $sectionid ?>"  method="post"  class="needs-validation" novalidate>
         <h1 class="addtext mt-4">Edit Section Form</h1>
          <br><br>
      ...
      <div class=" input-group mb-3">
             <div class="input-group-prepend">
                          <span class="input-group-text">Section</span>
                           <input type="text" name="Sid"  class="form-control" value=" <?php echo $sectionid; ?>" disabled>
              </div> 
...
<div class="cols-12 mt-5">
                   <input type="submit" name="UpSec" class="btn btn-primary" value="Update Section">
