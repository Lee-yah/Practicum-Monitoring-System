            ...
            <div class=" input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">Course</span>
                           <input type="text" name="cmid"  placeholder="Optional Last Number: <?php echo $courseid; ?>" class="form-control" value="<?php echo $c=$courseid+1; ?>" >
                        </div>
                               <input name="course" class="form-control instructorh"  autocomplete="off" placeholder="BSCS - Bachelor of Science in Computer Science" >
