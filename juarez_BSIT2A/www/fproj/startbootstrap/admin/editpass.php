...
$Gsid = $_GET['Guserr'];
    $query = " select * FROM user where user_id='".$Gsid."'";
...
<div class=" mt-3 ml-5 "><a href="\www\fproj\startbootstrap\index1.php" ><button  type="button" class="btn btn-outline-light btn-circle btn-lg"><i class="fa fa-close"></i></button>  
</a> </div>
...
<div class ="card-body  ">
             ...
             <form  id="myForm shadow" action="updatepass.php?GID=<?php echo $userid ?>" method="post"  class="needs-validation" novalidate>
                 <h3 style="color: maroon;font-size: 18pt;font-weight: bold;">Change Password</h3>
                       <div class="form-group form-group-sm">
                     <label>New Password:</label> 
                        <input type="text" name="newpass" class="form-control"  minlength="8" required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please enter a valid input in this field.</div>
                    </div> 
                      <input type="submit" name="ChangePass" class="btn btn-danger" value="Change Password">
