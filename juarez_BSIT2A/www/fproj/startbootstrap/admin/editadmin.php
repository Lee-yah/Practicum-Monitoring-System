 ...
 <form  id="myForm shadow" action="update.php?GID=<?php echo $cid ?>"  method="post"  class="needs-validation" novalidate>
         <h1 class="addtext mt-4">Edit Company Form</h1>
          <br><br>
           ...
           <strong>Processing! </strong> <?php echo $username ?>  is being updated 
           </div>

<div class="row">
            <div class=" col form-group form-group-sm">
          <label>User Id:</label> 
                <input type="text" name="address" class="form-control" value="<?php  echo $compaddress ?>" disabled>
          ...
          <input type="submit" name="UpAdmin" class="btn btn-primary" value="Update Admin">
