...
<div class ="card-body  ">
             ...
             <form  id="myForm shadow" action="updateprofile.php?GID=<?php echo $userid ?>" method="post"  class="needs-validation" novalidate>
                 <h3 style="color: maroon;font-size: 18pt;font-weight: bold;">Edit Username</h3>
                       <div class="form-group form-group-sm">
                     <label>Username : </label> 
                        <input type="text" name="newusername" class="form-control"  value="<?php echo $username ?>" minlength="8" required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please enter a valid input in this field.</div>
                    </div> 
                      <input type="submit" name="ChangePass" class="btn btn-danger" value="Update profile">
