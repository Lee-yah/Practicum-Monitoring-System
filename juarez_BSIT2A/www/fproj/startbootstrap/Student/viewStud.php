...
<div class=" mt-3 ml-5 "><a href="\www\fproj\startbootstrap\Practicum.php" ><button  type="button" class="btn btn-outline-light btn-circle btn-lg"><i class="fa fa-close"></i></button>  
</a> </div>
