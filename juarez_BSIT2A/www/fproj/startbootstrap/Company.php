...
<div id="page-content-wrapper">
      ...
      <div class="container-fluid ml-4 mb-5">
        <h1 class="mt-4 mr-4">Manage Company Information </h1>
     ...
     <div class="col-10">
          <div class="card shadow mb-4 " >
              <div class="card-header py-3">
                       <h4 class="m-0 font-weight-bold text-primary">Companies</h4>
                 </div>
                  <div class="card-body ">
                       <div class="d-flex justify-content-end flex-row">      
                                       <div class="btn-group-xs mr-4">
                                          <label type="button" class="text-primary mr-2">Add Company
                            ...
                            <div class="container mt-3">
                                 <h2>Company Table</h2>
                                  <p>Type something in the input field to search the table for name and address:</p>  
